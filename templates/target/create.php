...
<form action="index.php?controller=target&action=create" method="POST" class="form">
    <input type="hidden" name="createTarget">
    ...
    <input type="submit" value="Créer cible" class="btn btn-primary">
</form>
